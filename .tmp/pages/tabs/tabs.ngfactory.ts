...
class _View_TabsPage0 extends import1.AppView<import0.TabsPage> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_4,'tabIcon','md-stopwatch');
    this.renderer.setElementAttribute(this._el_4,'tabTitle','Timer');
    ...
    this.renderer.setElementAttribute(this._el_6,'tabIcon','md-stats');
    this.renderer.setElementAttribute(this._el_6,'tabTitle','Records');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_7:any = 'md-stopwatch';
