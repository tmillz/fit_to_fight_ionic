...
var _View_ContactPage0 = (function (_super) {
    ...
    _View_ContactPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._Content_9_4 = new import14.Wrapper_Content(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_9), this.renderer, this.parentInjector.get(import23.App), this.parentInjector.get(import25.Keyboard), this.parentInjector.get(import26.NgZone), this.parentInjector.get(import22.ViewController, null), this.parentInjector.get(import27.Tabs, null));
        ...
        this._List_11_3 = new import15.Wrapper_List(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_11), this.renderer, this.parentInjector.get(import28.GestureController));
        ...
        this._Item_13_4 = new import16.Wrapper_Item(this.parentInjector.get(import29.Form), this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_13), this.renderer);
        ...
        this._Item_16_4 = new import16.Wrapper_Item(this.parentInjector.get(import29.Form), this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_16), this.renderer);
        ...
        this._Icon_18_3 = new import19.Wrapper_Icon(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_18), this.renderer);
    ...
    _View_ContactPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import32.Item) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._Item_13_4.context;
        }
        if (((token === import33.ListHeader) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._ListHeader_13_5.context;
        }
        if (((token === import34.Icon) && (18 === requestNodeIndex))) {
            return this._Icon_18_3.context;
        }
        if (((token === import32.Item) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._Item_16_4.context;
        }
        if (((token === import32.ItemContent) && ((16 <= requestNodeIndex) && (requestNodeIndex <= 19)))) {
            return this._ItemContent_16_5.context;
        }
        if (((token === import35.List) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 20)))) {
    ...
    _View_ContactPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_3 = 'ionic';
        this._Icon_18_3.check_name(currVal_3, throwOnChange, false);
        ...
        var currVal_4 = this._Icon_18_3.context._hidden;
